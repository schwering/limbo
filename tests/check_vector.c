...
START_TEST(test_vector_insert)
{
    ...
    ck_assert_int_eq(vector_get(&vec1, 0), 1);
    ck_assert_int_eq(vector_get(&vec1, 1), 2);
    ck_assert_int_eq(vector_get(&vec1, 2), 3);
    ...
    ck_assert_int_eq(vector_get(&vec2, 0), 1);
    ck_assert_int_eq(vector_get(&vec2, 1), 2);
    ck_assert_int_eq(vector_get(&vec2, 2), 3);
